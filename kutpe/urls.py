...
from users.views import CustomRegisterView, VerifyPhone, SendOTP, add_to_queue, process_current_pos, GetNearestBanks, GetNearestBanksByLocation, GetTime, GetWaitingTime, GetQueue, CreateUser, RemoveFromQueue, GetUser, CreateQueue
...
urlpatterns = [
    ...
    path("process-current-pos/<int:org_id>",
